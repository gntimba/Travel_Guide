 ...
 */
public class DatePickerFragmentupdate extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        TextView tv = (TextView) getActivity().findViewById(R.id.dob);
